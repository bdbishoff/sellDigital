...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  if (orderUserId !== user?.id) {
    return redirect(`/sign-in?origin=thank-youorderId=${order.id}`);
  }
  ...
  return (
    <main className="relateive lg:min-h-full">
        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              ...
              <p className="mt-2 text-base text-muted-foreground">
                We appreciate your order, and we&apos;re currently processing it. Hang tight and we
            ...
            <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
              ...
              <div className="flex items-center justify-between border0t border-gray-200 pt-6 text-gray-900">
